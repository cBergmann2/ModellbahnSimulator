...
void logGetCurrentTaskId(void) { logTraceSet.id = (xSchedulerRunning == pdTRUE) ? (unsigned char)pxCurrentTCB->uxTCBNumber : (unsigned char)LOG_TASKID_UNKNOWN; }
#else
void logGetCurrentTaskId(void) { logTraceSet.id = (unsigned char)LOG_TASKID_UNKNOWN; }
#endif
#endif
